...
<body>
	...
	<?php include_once 'menuOperador.php'; ?>
	  			...
	  			<tbody>
	  				...
	  				<?php foreach($dados as $chave=>$string): ?>
	  					...
	  					<tr>
		  					...
		  					<td>
		  						<button class="btn btn-danger btn-xs disabled" data-bs-toggle="modal" data-bs-target="#deletar-<?=$chave;?>"> 
