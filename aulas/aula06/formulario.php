				...
				<div class="card">
				  ...
				  <div class="card-body">
				    <div class="row">
						...
						<div class="col-md-6">
		  					<label> RG: <span class="text-danger">*</span></label><br>
							<input type="text" name="rg" class="form-control" required placeholder="Digite seu RG"><br>
		  				</div>
		  				...
		  				<div class="col-md-6">
							...
							<input type="text" name="estado" class="form-control" required placeholder="Digite seu Estado"><br>
		  				</div>

		  				<div class="col-md-6">
		  					<label> Cidade: <span class="text-danger">*</span></label><br>
							<input type="text" name="cidade" class="form-control" required placeholder="Digite sua cidade"><br>
		  				</div>
